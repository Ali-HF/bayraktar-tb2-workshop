...
const PlaneData = {
  ...
  electronics: {
    motor: {
      label: 'Motor',
      tiers: [
        { id: 'motor-custom', name: 'Brushless DC Motor',             kv: 1090, watts: 250, maxCurrent: 22, weight: 175, thrust_g: 920,  price: 400,   desc: 'Budget sheet brushless motor' },
    ...
    esc: {
      label: 'ESC',
      tiers: [
        { id: 'esc-custom', name: 'Electronic Speed Controller (ESC)', currentRating: 60, weight: 63, price: 6800,  desc: '60A ESC from budget sheet' },
    ...
    battery: {
      label: 'Battery (LiPo)',
      tiers: [
        { id: 'bat-custom', name: 'LiPo Battery',                capacity: 2200, cells: 3, voltage: 11.1, cRating: 30, weight: 180, price: 4990,  desc: '3S LiPo battery from budget sheet' },
    ...
    servo: {
      label: 'Servos (×3)',
      tiers: [
        { id: 'servo-custom', name: '9g micro servos (2 active + 2 spare)', torque: 2.0, speed: 0.08, weight: 9,  price: 9000,  qty: 4, desc: 'Servos set from budget sheet' },
    ...
    prop: {
      ...
      tiers: [
        { id: 'prop-custom', name: 'Prop Saver/ Prop Adapter', diameter: 9,  pitch: 6, weight: 12, price: 500,  desc: 'Prop saver/adapter from budget sheet' },
    ...
    receiver: {
      label: 'Receiver',
      tiers: [
        { id: 'rx-custom', name: 'RC Reciever',               channels: 6,  weight: 15, price: 5499,  desc: 'RC Receiver from budget sheet' },
    ...
    transmitter: {
      ...
      tiers: [
        { id: 'tx-custom', name: 'RC Transmitter',             channels: 10, weight: 392, price: 21500, desc: 'RC Transmitter from budget sheet' },
    ...
    wiring: {
      ...
      tiers: [
        { id: 'wire-custom', name: 'Power Distribution / Wiring', weight: 18, price: 210,   desc: 'Wiring from budget sheet' },
    ...
    voltmonitor: {
      ...
      tiers: [
        { id: 'vmon-custom', name: 'Voltage Monitor / Alarm',      weight: 7, price: 668,   desc: 'Voltage Alarm from budget sheet' },
  ...
  /** Additional build items from sheet 1 (sum = 45,700 PKR) */
  additionalBuildItems: [
    { name: 'Emax GT2826-04, 1090KV motor', price: 6500 },
    { name: '60A ESC', price: 5000 },
    { name: '3S 2200mAh 30C LiPo battery', price: 4800 },
    { name: 'FlySky FS-i6X TX + FS-iA6B RX set', price: 12500 },
    { name: '10x6 propellers (incl. spares)', price: 4800 },
    { name: 'Covering film (self-adhesive)', price: 5000 },
    { name: 'Adhesives & hardware (hot glue/epoxy)', price: 2000 },
    { name: 'Paint / finishing (spray cans)', price: 3600 },
    { name: 'Tools & consumables (blades/sandpaper)', price: 1500 }
  ],
